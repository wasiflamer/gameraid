...
class _catagoriesState extends State<catagories> {
  ...
  Widget build(BuildContext context) {
    ...
    double left_padding_size = 0.0 ;
    double correction_factor = 0.0 ; 

    double screen_weight = MediaQuery.of(context).size.width * MediaQuery.of(context).devicePixelRatio;

    if ( screen_weight <= 1080.0)
    {

      left_padding_size = 197.0 ;
      correction_factor = 44.0  ; 

    }
    else if ( screen_weight > 1080.0 )
    {

      left_padding_size = 280 - 100 ;
      correction_factor = 80.0  ; 


    }

    debugPrint(screen_weight.toString());
    ...
    return Scaffold(
      ...
      body: GridView.count(
        ...
        padding: const EdgeInsets.only(bottom: 130 , left: 10, right: 10, top: 10, ),
             ...
             child: Container(
                ...
                child: Align(
                  alignment: FractionalOffset.center,
                        ...
                        child          : ListTile(      
                        contentPadding :  EdgeInsets.only(bottom: 10, left: 10, right: left_padding_size + correction_factor + 10),                                        
             ...
             child: Container(
                ...
                child: Align(
                  alignment: FractionalOffset.center,
                        ...
                        child          : ListTile(      
                        contentPadding : EdgeInsets.only(bottom: 10, left: 10, right: left_padding_size + correction_factor),                                        
             ...
             child: Container(
                ...
                child: Align(
                  alignment: FractionalOffset.center,
                        ...
                        child          : ListTile(      
                        contentPadding : EdgeInsets.only(bottom: 10, left: 10, right: left_padding_size ),                                        
                        textColor      : Colors.white,                       
                        subtitle       : Container(
                        padding        : const EdgeInsets.only(left: 10, right: 10, bottom: 10, top: 10),                    
                        decoration     :  BoxDecoration(
             ...
             child: Container(
                ...
                child: Align(
                  alignment: FractionalOffset.center,
                        ...
                        child          : ListTile(      
                        contentPadding : EdgeInsets.only(bottom: 10, left: 10, right: left_padding_size + correction_factor - 20),                                        
                        textColor      : Colors.white,                       
                        subtitle       : Container(
                        padding        : const EdgeInsets.only(left: 10, right: 10, bottom: 10, top: 10),                    
                        decoration     :  BoxDecoration(
