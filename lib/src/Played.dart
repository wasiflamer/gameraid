...
import 'package:collectify/src/databaseclass.dart';
...
final Widget png = Image.asset('images/hero.jpg' , width: 300 , height: 100 );
                        ...
                        else if (snapshot.hasData)
                        {
                            ...
                            itemBuilder: (BuildContext context, index)  {
                             ...
                             onLongPress: () async {
                                ...
                                DatabaseHelper.instance.deletenote(int.parse(snapshot.data[index]['game_id'].toString()));

                                // delete cover to save space . 
                                deleteFile(File('/storage/emulated/0/Android/data/com.example.GameRaid/files/Game_Covers/1080p/${snapshot.data[index]['game_id']}.jpg'));
